...
const AccountSquare = () => {
  ...
  return (
    <div className="w-52 h-full rounded-t-xl overflow-clip">
      <div className="bg-[#404040] h-48 bg-opacity-50 relative">
        <div className="h-full -translate-x-4 flex flex-col justify-center items-center text-white">
          <div className="relative w-24 h-24 rounded-full overflow-clip flex justify-center items-center bg-[#404040]">
            {user?.avatar ? (
              <Image
          ...
          <span className="mt-3 text-base">{user?.nickname}</span>
