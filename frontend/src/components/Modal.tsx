...
import { ExclamationCircleSolidIcon, CheckCircleOutlineIcon } from "./icons";
...
export const Modal = ({
  ...
  const colors =
    type === "success"
      ? {
          title_bg: "bg-emerald-100",
          title_text: "text-emerald-500",
          btn_bg: "bg-emerald-500",
          hover_btn_bg: "hover:bg-emerald-600",
          focus_btn_bg: "focus:ring-emerald-500",
        }
  ...
  const TitleIcon =
    titleIcon ||
    (type === "success" ? CheckCircleOutlineIcon : ExclamationCircleSolidIcon);
          ...
          >
            <div className="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg">
              {children ? (
                ...
                <div className="bg-white min-w-[480px] px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
